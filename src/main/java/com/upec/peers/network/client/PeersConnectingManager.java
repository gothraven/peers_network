...
public class PeersConnectingManager {
	...
	public PeersConnectingManager(DataBase dataBase, Logger logger) {
		this.logger = logger;
	...
	void putFragmentInFile(String fileName, ByteBuffer blob) throws IOException {
		this.dataBase.putFileFragment(fileName, blob);
	}
